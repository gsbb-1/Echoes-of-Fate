...
- 2026-09-16 — Drafted Chapters 25-26, the resolution pair (What's Left
  Standing — each character's own fallout: Jack files the box for the last
  time; Emma gives the parcel to the town as memorial ground; Sarah and
  Diane make their first real sentence; Michael calls his mother; Liam and
  Olivia trade the sliver for the true version; Echoes of Fate — some
  weeks later, same light, same six, none the same: Sarah paints the glint
  deliberately, Olivia opens the bottom drawer, Liam finishes the archive,
